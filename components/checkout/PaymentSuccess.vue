<template>
  <div class="min-h-screen flex flex-col">
    <div class="pt-12 md:pt-16 text-center relative z-10">
      ...
      <form
        class="py-6 px-8 max-w-4xl mx-auto my-20 sm:(mt-20 mb-12) text-left flex flex-col sheet gap-4"
      >
        <div>
          <div>
            <li class="text-2xl font-bold flex gap-5">Payment has been completed successfully<img class="w-5" src="@/assets/icons/checkmark.svg" alt="right check" /></li>
          </div>

          <br />
          <div>
              <p>
                Your purchase will be credited in the next 5 minutes, it is important that you reload the page. If you do not receive the benefit please send an email telling us the problem,
                <span class="font-bold text-green-500">partyfinderfaq@gmail.com</span>.
              </p>
          </div>
        </div>
        <Button
